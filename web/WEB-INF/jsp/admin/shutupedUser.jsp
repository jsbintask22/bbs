...
%>
<body>
<form method="post" action="/admin/usersStatusUpdate">
            ...
            <tr>
                ...
                <td>
                    <div class="button-group"><a class="button border-red" href="javascript:void(0)"
                                                 onclick="shutup(<%=user.getUser_id()%>)"><span class="icon-trash-o"></span> 解除</a>
                    </div>
                </td>
            </tr> <!--一个用户结束啦-->
